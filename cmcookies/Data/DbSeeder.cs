...
public static class DbSeeder
{
        ...
        RoleManager<Role> roleManager)
    {
        ...
        if (!context.Materials.Any())
        {
            ...
            {
                // Ingredientes secos
                new Material { Name = "Harina", Unit = "g", Stock = 5000, UnitCost = 0.035m },
                new Material { Name = "Azúcar blanca", Unit = "g", Stock = 3000, UnitCost = 0.035m },
                new Material { Name = "Azúcar morena", Unit = "g", Stock = 2000, UnitCost = 0.042m },
                new Material { Name = "Azúcar glass", Unit = "g", Stock = 1000, UnitCost = 0.035m },
                new Material { Name = "Cocoa", Unit = "g", Stock = 500, UnitCost = 0.573m },
                new Material { Name = "Bicarbonato", Unit = "g", Stock = 200, UnitCost = 0.03m },
                new Material { Name = "Sal", Unit = "g", Stock = 500, UnitCost = 0.00m },
                
                // Lácteos y huevos
                new Material { Name = "Mantequilla La Perfecta", Unit = "g", Stock = 2000, UnitCost = 0.53m },
                new Material { Name = "Huevo", Unit = "unidad", Stock = 60, UnitCost = 5.5m },
                
                // Chocolates
                new Material { Name = "Chispas chocolate", Unit = "g", Stock = 1000, UnitCost = 0.56m },
                new Material { Name = "Chocolate blanco", Unit = "g", Stock = 500, UnitCost = 0.52m },
                new Material { Name = "Mini chocolate", Unit = "unidad", Stock = 100, UnitCost = 7.30m },
                
                // Extras
                new Material { Name = "Oreo normal", Unit = "unidad", Stock = 100, UnitCost = 1.95m },
                new Material { Name = "Marshmallow", Unit = "g", Stock = 500, UnitCost = 0.27m },
                new Material { Name = "Pistacho sin cáscara", Unit = "g", Stock = 300, UnitCost = 0.794m },
                new Material { Name = "Pistacho con cáscara", Unit = "g", Stock = 300, UnitCost = 0.593m },
                new Material { Name = "Nutella", Unit = "g", Stock = 1000, UnitCost = 0.50m },
                
                // Saborizantes
                new Material { Name = "Esencia", Unit = "ml", Stock = 100, UnitCost = 1.2m },
                new Material { Name = "Colorante", Unit = "ml", Stock = 50, UnitCost = 1.17m },
                
                // Empaque
                new Material { Name = "Vasito cupcake", Unit = "unidad", Stock = 200, UnitCost = 0.24m },
                new Material { Name = "Bolsa celofán", Unit = "unidad", Stock = 200, UnitCost = 1.15m },
                new Material { Name = "Bolsa papel pequeña", Unit = "unidad", Stock = 50, UnitCost = 1.50m },
                new Material { Name = "Bolsa papel mediana", Unit = "unidad", Stock = 30, UnitCost = 3.50m },
                new Material { Name = "Sticker", Unit = "unidad", Stock = 100, UnitCost = 0.60m }
            };
        ...
        if (!context.CookieMaterials.Any())
        {
            ...
            {
                // ===== RECETA S'MORES =====
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Mantequilla La Perfecta"), ConsumptionPerBatch = 230 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Azúcar morena"), ConsumptionPerBatch = 90 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Azúcar blanca"), ConsumptionPerBatch = 90 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Harina"), ConsumptionPerBatch = 500 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Chispas chocolate"), ConsumptionPerBatch = 100 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Huevo"), ConsumptionPerBatch = 3 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Esencia"), ConsumptionPerBatch = 5 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Marshmallow"), ConsumptionPerBatch = 120 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Mini chocolate"), ConsumptionPerBatch = 20 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Sal"), ConsumptionPerBatch = 2 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Vasito cupcake"), ConsumptionPerBatch = 20 },
                new CookieMaterial { CookieCode = smores.CookieCode, MaterialId = getMaterialId("Bolsa celofán"), ConsumptionPerBatch = 20 },
                
                // ===== RECETA OREO =====
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Mantequilla La Perfecta"), ConsumptionPerBatch = 230 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Azúcar morena"), ConsumptionPerBatch = 90 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Azúcar blanca"), ConsumptionPerBatch = 90 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Harina"), ConsumptionPerBatch = 500 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Chispas chocolate"), ConsumptionPerBatch = 100 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Oreo normal"), ConsumptionPerBatch = 29 }, // 9 triturada + 20 decoración
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Huevo"), ConsumptionPerBatch = 3 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Esencia"), ConsumptionPerBatch = 5 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Sal"), ConsumptionPerBatch = 2 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Nutella"), ConsumptionPerBatch = 160 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Vasito cupcake"), ConsumptionPerBatch = 20 },
                new CookieMaterial { CookieCode = oreo.CookieCode, MaterialId = getMaterialId("Bolsa celofán"), ConsumptionPerBatch = 20 }
            };
