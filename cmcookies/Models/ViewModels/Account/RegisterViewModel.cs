...
public class RegisterViewModel
{
    ...
    public string FirstName { get; set; } //almacena el primer nombre y se valida que no este vacio y que no pase de 50 caracteres
    ...
    [Display(Name = "Email")]
    public string Email { get; set; } //validacion, ya lo hace el framework y busca que tenga el formato de un correo electronico
    ...
    public string ConfirmPassword { get; set; } //existe aca, dentro del viewmodel meramente para confirmar de que el usuario escribio bien su contraseña y 
}
