...
public class LoginViewModel
{
    ...
    public bool RememberMe { get; set; } //Si esto de aca se pone en true, la cookiesession durara 14 dias si es false expira al cerrar el navegador GET/POST i think??
