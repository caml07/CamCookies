...
public class CheckoutViewModel
{
    ...
    public string ShippingType { get; set; } //otro campo necesario, para saber donde val el pedido 'on campus' o 'outside campus'
    ...
    public string ShippingSite { get; set; } //otro campo necesario para saber mas especificamente donde debe de ir el pedido

    // Optional: Customer notes
    [StringLength(500, ErrorMessage = "The notes cannot be longer than 500 characters")]
    [Display(Name = "Additional Notes (optional)")]
    public string Notes { get; set; } //un campo opcional que puede servir para que el usuario ponga algo extra si el desea
}
