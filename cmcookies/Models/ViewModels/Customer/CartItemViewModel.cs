...
public class CartItemViewModel
{
    ...
    CookieCode
  {
    get;
    set;
  } //para que cuando el cliente quiera cambiar la cantidad o eliminar el producto del carrito, el sistema ocupa CookieCode para saber a que cookie se refiere
