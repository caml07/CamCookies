...
{
    public int? CookieCode { get; set; } //Es NULL si es una galleta nueva, y tiene valor por qué ya hay una galleta con el code
    ...
    [Display(Name = "Name")]
    public string CookieName { get; set; } //Guardar el nombre de la cookie, con constrain de no mayor a 50 caracteres le nombre
