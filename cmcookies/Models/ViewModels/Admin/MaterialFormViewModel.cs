...
public class MaterialFormViewModel
{
    ...
    [Display(Name = "Stock")]
    public decimal Stock { get; set; } //no puede ser ningun número negativo y tiene un límite hasta 100000 y puede ser decimal, si se quiere registrar por ej., que queda 1.5 Kg de harina o que sé yo
