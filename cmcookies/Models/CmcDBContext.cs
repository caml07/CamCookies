...
public partial class CmcDBContext : IdentityDbContext<User, Role, int> //inheritamos de la monda' esa para que nos incluya tablas de Identity(User, Roles....) y tambien para que ya configure por si solo las relaciones de Identity. Tambien no sda acceso a UserManager,  RoleManager, SignInManager...
{
    public CmcDBContext() {} //Constructor sin parametros para migraciones de Entity Framework

    public CmcDBContext(DbContextOptions<CmcDBContext> options)
        : base(options) {} //pasamos las opciones al constructor base de ID
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Transaction>(entity =>
        {
            ...
            entity.HasOne(d => d.Batch)
                ...
                .OnDelete(DeleteBehavior.SetNull) //en este caso si se borra el batch, tambien se borra la transaccion FK -> NULL
